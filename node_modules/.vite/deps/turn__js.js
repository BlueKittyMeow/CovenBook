...
// node_modules/turn.js/node_modules/jquery/dist/jquery.js
var require_jquery = __commonJS({
  "node_modules/turn.js/node_modules/jquery/dist/jquery.js"(exports, module) {
    (function(global, factory) {
      ...
      var support = {};
      var version = "1.12.0", jQuery = function(selector, context) {
      ...
      jQuery.event = {
        ...
        add: function(elem, types, handler, data, selector) {
          var tmp, events2, t, handleObjIn, special, eventHandle, handleObj, handlers, type, namespaces, origType, elemData = jQuery._data(elem);
          if (!elemData) {
            return;
          }
          if (handler.handler) {
        ...
        remove: function(elem, types, handler, selector, mappedTypes) {
          var j, handleObj, tmp, origCount, t, events2, special, handlers, type, namespaces, origType, elemData = jQuery.hasData(elem) && jQuery._data(elem);
      ...
      jQuery.removeEvent = document2.removeEventListener ? function(elem, type, handle) {
      ...
      function cloneCopyEvent(src, dest) {
        ...
        var type, i2, l, oldData = jQuery._data(src), curData = jQuery._data(dest, oldData), events2 = oldData.events;
        if (events2) {
      ...
      function getWidthOrHeight(elem, name, extra) {
        ...
        if (document2.msFullscreenElement && window2.top !== window2) {
      ...
      jQuery.ajaxTransport("script", function(s) {
        if (s.crossDomain) {
          var script, head = document2.head || jQuery("head")[0] || document2.documentElement;
          return {
      ...
      support.createHTMLDocument = function() {
        if (!document2.implementation.createHTMLDocument) {
          return false;
        }
        var doc = document2.implementation.createHTMLDocument("");
      ...
      jQuery.parseHTML = function(data, context, keepScripts) {
        ...
        context = context || (support.createHTMLDocument ? document2.implementation.createHTMLDocument("") : document2);
...
jquery/dist/jquery.js:
   ...
   *)
*/
//# sourceMappingURL=turn__js.js.map
